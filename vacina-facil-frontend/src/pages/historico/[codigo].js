...
const STATUS_BADGE = {
  ...
  ATRASADO:  { label: "Atrasado",  cls: "badge-atrasado"  },
      ...
      <div style={{ maxWidth:560, margin:"0 auto", position:"relative", zIndex:1 }}>
        ...
        <div style={{ display:"flex", alignItems:"center", justifyContent:"space-between", marginBottom:"1rem" }}>
          ...
          <div style={{ display:"flex", gap:8 }}>
            <Link
              href={`/calendario?codigo=${codigo}`}
              style={{ background:"#0D1117", color:"#9CA3AF", border:"1px solid #1C2631", borderRadius:10, padding:"9px 14px", fontSize:13, fontWeight:500, fontFamily:"'DM Sans',sans-serif", display:"flex", alignItems:"center", gap:6, textDecoration:"none", transition:"all .15s" }}
            >
              <svg width="13" height="13" viewBox="0 0 13 13" fill="none">
                <rect x="1" y="2.5" width="11" height="9.5" rx="2" stroke="currentColor" strokeWidth="1.4"/>
                <path d="M4 1v3M9 1v3M1 6h11" stroke="currentColor" strokeWidth="1.4" strokeLinecap="round"/>
              </svg>
              Calendário
            </Link>
            ...
            {historico.map((a) => {
              ...
              return (
                <div
                  ...
                  style={{ background:"#0D1117", border:"1px solid #1C2631", borderRadius:14, padding:"1.1rem 1.25rem", display:"flex", alignItems:"center", justifyContent:"space-between", gap:"1rem", marginBottom:10, cursor:"pointer" }}
                >
                  ...
                  <div style={{ display:"flex", flexDirection:"column", alignItems:"flex-end", gap:6, flexShrink:0 }}>
                    ...
                    {a.status === "PENDENTE" && (
                      <button
                        ...
                        className="vf-marcar"
                        style={{ fontSize:11.5, color:"#2D3A47", background:"none", border:"none", fontFamily:"'DM Sans',sans-serif", cursor:"pointer", padding:0, transition:"color .2s" }}
                      >
